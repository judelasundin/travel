    ...
    <div className="flex items-center justify-center h-screen mb-12 bg-fixed bg-center bg-cover backdrop-opacity-60 custom-img">
        ...
        <div className="text-center">
            <h2 className="text-6xl font-bold mb-4 text-white">
              Explore the Best of the <br/>Philippines</h2>
            <p className=" text-white mb-36">Discover Authentic Adventures and Hidden Gems with Travel Authentic Philippines</p>
            <SearchBar/>
        </div>
